...
real*8, parameter :: wtol = epsilon(1.0d0), dr1 = 1.25d0, dr2 = 1.11d0, dr3 = 1.11d0
...
open(unit=1001,file=trim(datapath)//"asymp1.dat", status = "old")
...
subroutine no22appes(tmpr, totener, dvdr)
use surface1
implicit none
